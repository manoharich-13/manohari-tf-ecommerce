...
data "archive_file" "product_zip" {
  type        = "zip"
  source_file = "manohari_tf_product_service/product_service.py"
...
data "archive_file" "cart_zip" {
  type        = "zip"
  source_file = "manohari_tf_cart_service/cart_lambda.py"
  output_path = "cart_service/cart_service.zip"
}
...
data "archive_file" "payment_zip" {
  type        = "zip"
  source_file = "manohari_tf_payment_service/payment.py"
  output_path = "payment_service/payment_service.zip"
}
